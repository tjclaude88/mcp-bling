...
const PHYSICAL_MATERIAL: TraitPool = [
  ...
  { value: "a plain grey jumper, sleeves slightly too long",        band: "Common" },
  { value: "a rotation of four identical button-downs",             band: "Common" },
  { value: "the office-standard polo and pleated slacks",           band: "Common" },
  { value: "a slightly-too-big blazer over a plain tee",            band: "Common" },
  { value: "chinos, a belt, and shoes that are technically trainers", band: "Common" },
  { value: "a fleece vest indoors, year-round",                     band: "Common" },
  { value: "a lanyard with three expired visitor passes",           band: "Common" },
  { value: "a navy jumper that has pilled beyond saving",           band: "Common" },
  { value: "sensible trousers and a shirt that needs an iron",      band: "Common" },
  { value: "a plain hoodie worn over business-casual",              band: "Common" },
  { value: "glasses perpetually smudged in the same corner",        band: "Common" },
  { value: "a wristwatch that stopped but is still worn daily",     band: "Common" },
  { value: "permed hair that hasn't changed since 1994",            band: "Uncommon" },
  { value: "a shirt with a faint coffee stain nobody mentions",     band: "Uncommon" },
  { value: "a tie wider than any tie sold after 2003",              band: "Uncommon" },
  { value: "socks with sandals, committed to the bit",              band: "Uncommon" },
  { value: "a waistcoat worn unironically, every single day",       band: "Uncommon" },
  { value: "a bluetooth earpiece clipped on but never connected",   band: "Uncommon" },
  { value: "a belt two notches tighter than appears comfortable",   band: "Uncommon" },
  ...
  { value: "a hand-knitted jumper depicting their own face, worn without comment", band: "Mythic" },
];
